...
/**
 * Titles commonly have requirements for purchase or for display. Any title that
 * implements this interface will more than likely have a requirement or standard
...
public interface TitleRequirement {
	 ...
	 * 			The player
	 * @return
	 * 			By default the function returns true unless defined otherwise.
	 */
