...
/**
 * Although the delete buttin may be the value of (edit - 1), values
...
public enum PresetSlotAction {
	...
	PresetSlotAction(int slot, int edit, int delete) {
		this.slot = slot;
		this.edit = edit;
		this.delete = delete;
	...
	public static final Set<PresetSlotAction> SLOTS = Collections.unmodifiableSet(
			EnumSet.allOf(PresetSlotAction.class));
