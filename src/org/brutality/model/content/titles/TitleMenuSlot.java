...
/**
 * Represents a single slot on the interface. Please note that although the slots
 * are ordered in numberical order and that the button id's do have a pattern. 
 * However, in case of change I have provided this enum.
 * 
...
public enum TitleMenuSlot {
	 ...
	 * @return	A {@link TitleMenuSlot} object if the button matches any of the button values
