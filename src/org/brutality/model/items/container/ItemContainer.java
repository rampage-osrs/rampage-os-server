package org.brutality.model.items.container;
...
public abstract class ItemContainer {
	 ...
	 * @param itemId	the item that must exist at the slot otherwise this will fail
	 ...
	 *
	 * @param itemId	the item we're determining exists in the slot
	 * @param amount 	the amount we're determining exists in the slot
