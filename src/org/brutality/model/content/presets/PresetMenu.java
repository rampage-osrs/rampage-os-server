...
public enum PresetMenu {
	...
	/**
	 * The menu has several actions; Viewing, loading, and saving. Each action
	 * has a button value associated with it. 
	 * @param loadInventory	clicked to load the inventory
	 * @param loadEquipment	clicked to load the equipment
	 */
	PresetMenu(int slot, int view, int loadEquipment, int loadInventory, int alias) {
		this.slot = slot;
		this.view = view;
