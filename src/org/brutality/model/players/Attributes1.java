...
public final class Attributes1 {
	 ...
	 */
	private Map<Object, Object> attributes1 = new HashMap<Object, Object>();
	...
	public Object get(Object key, Object fail) {
		Object value = attributes1.get(key);
		if (value == null) {
			return fail;
		}
		return value;
	...
	public boolean isSet(Object key) {
		return attributes1.containsKey(key);
	}
	...
	public void set(Object key, Object value) {
		if (attributes1.containsKey(key)) {
			attributes1.remove(key);
		}
