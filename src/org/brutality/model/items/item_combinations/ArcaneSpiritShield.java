...
public class ArcaneSpiritShield extends ItemCombination {
	...
	public ArcaneSpiritShield(Optional<int[]> skillRequirements, GameItem outcome, Optional<List<GameItem>> revertedItems, GameItem[] items) {
	...
	public void combine(Player player) {
		...
		player.getDH().sendStatement("You combined the items and created the Arcane Spirit Shield.");
