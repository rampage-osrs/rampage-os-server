...
public class CraftingData extends SkillHandler {
	...
	public enum tanningData {
		...
		HARD_LEATHER(new int[][] {{57226, 1}, {57218, 5}, {57202, 28}}, 1739, 1743, 2, new int[] {14778, 14786, 14770}, "Hard leather"),
		SNAKESKIN(new int[][] {{57227, 1}, {57219, 5}, {57203, 28}}, 6287, 6289, 4, new int[] {14779, 14787, 14771}, "Snakeskin"),
		SNAKESKIN2(new int[][] {{57228, 1}, {57220, 5}, {57204, 28}}, 6287, 6289, 4, new int[] {14780, 14788, 14772}, "Snakeskin"),
		GREEN_DRAGON_LEATHER(new int[][] {{57229, 1}, {57221, 5}, {57205, 28}}, 1753, 1745, 5, new int[] {14781, 14789, 14773}, "Green d'hide"),
		BLUE_DRAGON_LEATHER(new int[][] {{57230, 1}, {57222, 5}, {57206, 28}}, 1751, 2505, 6, new int[] {14782, 14790, 14774}, "Blue d'hide"),
		RED_DRAGON_LEATHER(new int[][] {{57231, 1}, {57223, 5}, {57207, 28}}, 1749, 2507, 8, new int[] {14783, 14791, 14775}, "Red d'hide"),
		BLACK_DRAGON_LEATHER(new int[][] {{57232, 1}, {57224, 5}, {57208, 28}}, 1747, 2509, 10, new int[] {14784, 14792, 14776}, "Black d'hide");
	...
	public enum cutGemData {
		...
		ONYX(6571, 6573, 67, 500, 885), /** Need correct animation ID **/
		OPAL(1625, 1609, 1, 12, 890),
		JADE(1627, 1611, 13, 20, 891),
		RED_TOPAZ(1629, 1613, 16, 25, 892),
		ZENYTE(19496, 19493, 92, 1000, 887);
