...
public class MaledictionWard extends ItemCombination {
	...
	public MaledictionWard(Optional<int[]> skillRequirements, GameItem outcome, Optional<List<GameItem>> revertedItems, GameItem[] items) {
	...
	public void combine(Player player) {
		...
		player.getDH().sendStatement("You combined the items and created the Malediction ward (or).");
	...
	public void showDialogue(Player player) {
		player.getDH().sendStatement("A Malediction ward (or) is untradeable.", 
