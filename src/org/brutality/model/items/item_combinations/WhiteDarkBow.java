...
public class WhiteDarkBow extends ItemCombination {
	...
	public WhiteDarkBow(Optional<int[]> skillRequirements, GameItem outcome, Optional<List<GameItem>> revertedItems, GameItem[] items) {
	...
	public void combine(Player player) {
		...
		player.getDH().sendStatement("You combined the items and created the White dark bow.");
	...
	public void showDialogue(Player player) {
		player.getDH().sendStatement("The White dark bow is untradeable.", 
