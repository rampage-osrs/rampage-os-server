...
public final class WorldMap {
	...
	public static boolean solidObjectExists(int x, int y) {
		...
		if (go != null && go.getType() == 2 && go.getX() == x && go.getY() == y) {
			return true;
		}
		if (go != null && go.getType() == 10 && go.getX() == x && go.getY() == y) {
			return true;
		}
		if (go != null && go.getType() == 9 && go.getX() == x && go.getY() == y) {
			return true;
		}
		if (go != null && go.getType() == 8 && go.getX() == x && go.getY() == y) {
			return true;
		}
		if (go != null && go.getType() == 7 && go.getX() == x && go.getY() == y) {
			return true;
		}
		return go != null && go.getType() == 4 && go.getX() == x && go.getY() == y;
	}
...
//						objectY, objectFace);
//				if (go.getType() != 0) {
//					gameObjects.put(go.getY() + (go.getX() << 16), go);
//				}
//			}
