	...
	public void foodEffect(int id) {
		...
		case 1907:
			...
			if (c.playerLevel[0] < 5) {
				...
				c.playerLevel[0] = c.getPlayerAssistant().getLevelForXP(
						c.playerXP[0]) - 4;
			}
			if (c.playerLevel[1] < 4) {
				c.playerLevel[1] = 1;
			} else {
				c.playerLevel[1] = c.getPlayerAssistant().getLevelForXP(
						c.playerXP[1]) - 3;
			}
			if (c.playerLevel[2] < 4) {
				c.playerLevel[2] = 1;
			} else {
				c.playerLevel[2] = c.getPlayerAssistant().getLevelForXP(
						c.playerXP[2]) - 3;
			}
